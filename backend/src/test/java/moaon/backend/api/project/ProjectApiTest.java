...
public class ProjectApiTest extends BaseApiTest {
    ...
    void saveProject() {
        ...
        // when
        ProjectCreateResponse response = RestAssured.given().log().all()
    ...
    void getArticlesByProjectId() {
        ...
        when(elasticSearchService.searchInProject(eq(targetProject), any(ProjectArticleQueryCondition.class)))
        ...
        // whenr
        ProjectArticleResponse actualResponse = RestAssured.given().log().all()
