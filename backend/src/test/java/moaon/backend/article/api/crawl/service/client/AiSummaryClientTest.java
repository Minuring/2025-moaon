...
@SpringBootTest(
        ...
        properties = {
                ...
                "resilience4j.circuitbreaker.configs.default.ignore-exceptions[0]=moaon.backend.article.api.crawl.exception.AiNoCostException",
                "resilience4j.circuitbreaker.configs.default.ignore-exceptions[1]=moaon.backend.article.api.crawl.exception.AiSummaryFailedException"
        }
)
